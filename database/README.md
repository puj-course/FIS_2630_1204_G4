...
En esta carpeta se encuentra la estructura inicial de la base de datos de SignIA. Para su desarrollo se utilizó PostgreSQL y, durante las pruebas, la base fue alojada en Neon.
